...
<div class="container-fluid container-library">
    <div class="main library">
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-9 col-sm-9">
                <div class="head-menu"><span><strong>Produit</strong></span>({{ $products['total'] }})</div>
                <div class="container-fluid group-box">
                    ...
                    <div class="col-lg-2 col-sm-2">
                        <img src="/image/front/Bibliotheque_Web_2.jpg" class="library-thumb">
                        <div class="menu-tooltips"></div>
                        <div class="thumb-title">
                            <span class="title"><strong>Title</strong></span>
                        </div>
                    ...
                    <div class="col-lg-2 col-sm-2">
                        <img src="/image/front/library-thumb-1.png" class="library-thumb">
                        <div class="menu-tooltips"></div>
                        <div class="thumb-title">
                            <span class="title"><strong>Title</strong></span>
                            <img src="/image/front/cdd-icon.png" class="cdd-icon">
                    ...
                    <div class="col-lg-2 col-sm-2">
                        <img src="/image/front/Bibliotheque_Web_3.jpg" class="library-thumb">
                        <div class="menu-tooltips"></div>
                        <div class="thumb-title">
                            <span class="title"><strong>Title</strong></span>
                            <img src="/image/front/cdd-icon.png" class="cdd-icon">
                    ...
                    <div class="col-lg-2 col-sm-2">
                        <img src="/image/front/Bibliotheque_Web_4.jpg" class="library-thumb">
                        <div class="menu-tooltips"></div>
                        <div class="thumb-title">
                            <span class="title"><strong>Title</strong></span>
                            <img src="/image/front/cdd-icon.png" class="cdd-icon">
